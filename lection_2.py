...
# def default_value(sym, count = 1): # присвоение значения по умолчанию для count
# 	return sym * count
...
# exp_tuple = (1, 2, 3)
# # one, two, three = exp_tuple
# # print(one) # 1

# # можно и так, заменить недостающую переменную "землёй"
# one, two, _ = exp_tuple
# print(two)

# можно вложить кортеж в кортеж, в таком случае обратиться к нему можно через двойные скобки []
...
# print(dct) # {0: 0, 1: 1}
dct[11] = 11 
# print(dct) # {0: 0, 1: 1, 11: 11}
# print(dct.keys()) # dict_keys([0, 1, 11])
# print(dct.values()) # dict_values([0, 1, 11])
# print(dct.items()) # пары (key: value) dict_items([(0, 0), (1, 1), (11, 11)])
# print(dct)
# ######################### запросы по ключу ########################
# print(dct[0]) 
# print(dct.get(1))
